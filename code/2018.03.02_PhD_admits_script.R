...
admissions_scenario <- function(rejection_rate = 0.8, admission_attempts = 20, scenario_runs = 2000, create_pic = TRUE) {
...
outcome_tibble_creator <- function(outcomes = c("UC Irvine", "Brandeis", "UT Austin", "BU", "Normie"),
                                   probability = c(0.5, 0.12, 0.35, 0.01, 0.02)) {
...
naive_admit_estimation <- function(admissions_attempts = 20, admits = 4, denies = 14,begin_date = as.Date("2018/01/20"),
