...
<p align="center">
  <b>
    <a href="https://github.com/justinsola/justinsola.github.com/raw/master/files/Sola CV Dec 2019.pdf">CV </a> | 
...
## About me
2nd year at UC Irvine's [Criminology, Law & Society](https://cls.soceco.uci.edu/pages/phd-program) PhD! I serve as Graduate Representative for the department, along with Veronica Gonzalez, and as an Editorial Assistant for <i>[Sociological Perspectives](https://journals.sagepub.com/home/spx)</i>.

My primary research areas are the drivers of [legal gun acquisition](https://github.com/justinsola/justinsola.github.com/raw/master/files/Approx_US_Firearm_Sales_by_Month_(Jan1999-Aug2017).pdf), how carceral contact affects inequality, the viability of mixed-methods social research, and how people consume security through training, equipment, group membership, and mindset adoption.  I want to conduct research that is rigorous, respects actors' frames of action, and that imputes adequate motives and mechanisms of behavior (to paraphrase Peter Bearman).
